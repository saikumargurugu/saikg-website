...
const ServiceCard: React.FC<ServiceCardProps> = ({ icon, title, description, children }) => {
  ...
  return (
    <div
      className={`${THEME.card} bg-white dark:bg-gray-800 hover:shadow-lg transition-shadow duration-300 p-6 h-full flex flex-col justify-between items-center`}
  ...
  <h3 className={`text-xl font-bold ${THEME.headingText} mb-2 text-center`}>
        {title}
      </h3>
...
const ServicesPage = () => {
  ...
  <div className="flex flex-col items-center w-full">
    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10 justify-items-center items-center w-fit mx-auto">
        ...
        <div className="mt-12 border-t border-pink-200 dark:border-indigo-700 py-8">
          <div className="text-center">
            <h2 className="text-3xl font-extrabold font-display text-pink-600 dark:text-indigo-300 mb-4 animate-glow drop-shadow-xl">
            ...
            <Link
              href="/contact"
              className="inline-block bg-pink-600 hover:bg-indigo-700 text-white font-bold py-3 px-8 rounded-full transition-all duration-500 shadow-lg"
            >
              Get in Touch
            </Link>
          </div>
